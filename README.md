...
8.  Create a "Service credential" for the newly restored ICD instance (KPP-RESTORE-PITR-TEST) in the cloud.ibm.com UI.
    1. login https://cloud.ibm.com/resources
    2. go to "Resource list" --> "Services" --> "the newly restored ICD instance (KPP-RESTORE-PITR-TEST)"
    3. on the left panel, click on "Service credentials"
    4. Click on the "New credential", specify a name on the popup and click "Add"
    5. all the info needed for the next step are in this new "Service credentials" instance
